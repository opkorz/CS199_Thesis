...
PARAM($RootCauseIndex, $RepairID, $RepairID1)
...
if($RootCauseIndex -eq $null)
{
     throw "No RootCauseIndex specified"
}
else
{
...
if($selectedRepair)
{
    ...
    $Global:ndfRerun = $null;
    $Global:LastRepairRCIndex = $RootCauseIndex; #the index for the last repair executed
